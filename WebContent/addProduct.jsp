	...
	<div class="container">
		<div class="row"
			...
			<form action="./AddProductSrv" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background-color: #fff; padding: 20px 40px; margin-top:4em;">
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: black; margin-bottom:1.3em;">Product Addition</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
