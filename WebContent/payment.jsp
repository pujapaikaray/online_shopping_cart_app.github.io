...
<body style="background-color: rgba(0, 0, 0, 0.068);">
	...
	<div class="container">
		<div class="row"
			...
			<form action="./OrderServlet" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background-color: #fff; padding: 20px 40px; margin-top:3em;">
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						<img src="images/profile.jpg" alt="Payment Proceed" height="100px" style= border-radius:4px; />
