...
<body style="background-color: rgba(0, 0, 0, 0.068);">
	...
	<div class="container">
		<div class="row"
			style="margin-top: 5px; margin-left: 2px; margin-right: 2px; background-color:#fff;">
			<form action="./UpdateProductSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						...
						<h2 style="color: green;">Product Update</h2>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6 form-group" style= background-color:red;>
						<%
