	...
	<div class="container">
		<div class="row"
			...
			<form action="updateProduct.jsp" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background-color: #fff; padding: 10px; margin-top:3em;">
				<div style="font-weight: bold;" class="text-center">
					<h3 style="color: black; margin-bottom:1.5em;">Product Update</h3>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
