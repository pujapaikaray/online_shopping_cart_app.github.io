	...
	<div class="container">
		<div class="row"
			...
			<form action="./RemoveProductSrv" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background-color: #fff; padding: 2em 4em; postion:relative; top:2em;">
				<div style="font-weight: bold;" class="text-center">
					<h3 style="color: black; postion:relative; top:2em;">Product Deletion </h3>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
